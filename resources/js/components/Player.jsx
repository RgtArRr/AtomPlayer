...
export default class Player extends React.Component {
    ...
    componentDidMount () {
        ...
        this.audioPlayer.current.addEventListener('ended', function () {
            let state = self.state;
    ...
    loadSong (_id) {
        ...
        this.props.db.getSong(_id, function (song) {
            if (song !== null) {
                ...
                state.thumbnail = song.thumbnail;
                state._id = song._id;
    ...
    makeSuffleList (_id) {
        let self = this;
        this.props.db.getSongsbySong(_id, function (data) {
            shuffleArray(data);
            ...
            [
                ...
                <div key={'div_player'} className="player">
                    ...
                    <button className="btn btn-default" onClick={() => {this.changeSong('prev');}}>
                        <span className="icon icon-to-start"/>
                    </button>
                    ...
                    <button className="btn btn-default" onClick={() => {this.changeSong('next');}}>
                        <span className="icon icon-to-end"/>
                    </button>
                ...
                <audio key={'audio_player'} src="" ref={this.audioPlayer}/>,
            ]
        );
    }
}
